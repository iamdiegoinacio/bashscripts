...
rm -r ChainDB /dev/null 2>&1
echo -e "\033[1;36mDOWNLOAD THE NEW DATABASE\033[0m"
echo ""
echo -e "\033[1;33mWAIT..."
wget https://nkn.org/ChainDB_pruned_latest.tar.gz /dev/null 2>&1
echo -e "\033[1;36mUNZIP DATABASE\033[0m"
echo ""
echo -e "\033[1;33mWAIT..."
tar -vzxf ChainDB_pruned_latest.tar.gz /dev/null 2>&1
echo -e "\033[1;36mREMOVING TEMP DATABASE FILES\033[0m"
echo ""
echo -e "\033[1;33mWAIT..."
rm -r ChainDB_pruned_latest.tar.gz /dev/null 2>&1
